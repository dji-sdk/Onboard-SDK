...
KEYBOARDTELEOP.Teleop = function(options) {
	...
	var nav_list = new Array("close","open");
	...
	var handleKey = function(keyCode, keyDown) {
		...
		case 90:  // key Z
			height_speed = 30*iskeydown;   // 0.3 * 100
			break;
		case 67:  // key C
			height_speed = -30*iskeydown;  // 0.3 * 100
			break;
	...
	var cmd0button = document.getElementById("cmd0-button");
	var cmd1button = document.getElementById("cmd1-button");
	var cmd2button = document.getElementById("cmd2-button");
	...
	cmd0button.addEventListener('mousedown', function(e) {
		// publish status change request
		var request = new ROSLIB.Message({
  			data : 0,
		});
	...
	cmd1button.addEventListener('mousedown', function(e) {
		// publish status change request
		var request = new ROSLIB.Message({
  			data : 1,
		});
	...
	cmd2button.addEventListener('mousedown', function(e) {
		// publish status change request
		var request = new ROSLIB.Message({
  			data : 2,
		});
