$(document).ready(function () {
  ...
  // sm sm-dox nav nav-tabs
  $('#main-menu').removeClass('navbar-nav').removeClass('navbar-right').addClass('nav-tabs navbar-left')
  $('#main-nav').removeClass('navbar-right').css('width', '100%')

  // Remove search box
  $('#main-menu').children(':last').remove()

  // Add back search box but our style
  $('#main-menu').after(`
  <div id="MSearchBox" class="MSearchBoxInactive">
    <div class="input-group">
        <span class="input-group-btn">
            <button aria-expanded="false" id="MSearchSelect" type="button" class="btn btn-default"
                onmouseover="return searchBox.OnSearchSelectShow()" onmouseout="return searchBox.OnSearchSelectHide()">
                <span class="glyphicon glyphicon-search"></span>
                <span class="caret"></span>
            </button>
        </span>
        <input type="text" id="MSearchField" class="form-control" value="" placeholder="Search..." accesskey="S"
          onfocus="searchBox.OnSearchFieldFocus(true)" onblur="searchBox.OnSearchFieldFocus(false)"
          onkeyup="searchBox.OnSearchFieldChange(event)" />
        <span class="input-group-btn">
        <button id="MSearchClose" onclick="return searchBox.CloseResultsWindow()" type="button" class="close"
            aria-label="Close">
