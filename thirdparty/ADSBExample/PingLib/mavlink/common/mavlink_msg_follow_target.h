...
{
	return mavlink_msg_follow_target_pack(system_id, component_id, msg, follow_target->timestamp, follow_target->est_capabilities, follow_target->lat, follow_target->lon, follow_target->alt, (float*)&follow_target->vel, (float*)&follow_target->acc, (float*)&follow_target->attitude_q, (float*)&follow_target->rates, (float*)&follow_target->position_cov, follow_target->custom_state);
}
