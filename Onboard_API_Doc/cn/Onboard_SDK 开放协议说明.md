...
*\*发送端使用这些SESSION 发送命令数据包时，应答包中包含该命令数据包中的 帧序列号(SEQ) 和 通信过程中的会话 ID (SESSION)。如果通信过程中，发送端没有正确收到应答包，可以重新发送包含相同SESSION和SEQ的命令数据包。*
...
<tr>
  <td>12</td>
  <td>32</td>
  <td>固定符串，"12345678901234567890123456789012"</td>
</tr>
