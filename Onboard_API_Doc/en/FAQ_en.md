...
### 20. Raw data included in Flight Data seems wrong in case of using simulator.  
Because raw data is generated from actual sensors on UAV, raw data will not be available in simulator. Please choose fusion data when you use DJI simulator.  