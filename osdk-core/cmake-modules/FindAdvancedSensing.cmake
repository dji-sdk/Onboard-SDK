...
if (ADVANCED_SENSING_LIBRARY AND ADVANCED_SENSING_INCLUDE_DIRS)
    ...
    find_path(ADVANCED_SENSING_INCLUDE_DIRS
            ...
            PATHS
            ${CMAKE_CURRENT_SOURCE_DIR}/advanced-sensing-2.0.2/inc
            ${EXECUTABLE_OUTPUT_PATH}/advanced-sensing-2.0.2/inc
            PATH_SUFFIXES
            advanced-sensing
            )
    ...
    find_library(ADVANCED_SENSING_LIBRARY
            ...
            advanced-sensing
            PATHS
            ${CMAKE_CURRENT_SOURCE_DIR}/advanced-sensing-2.0.2/lib
            ${EXECUTABLE_OUTPUT_PATH}/advanced-sensing-2.0.2/lib
            NO_DEFAULT_PATH
            )
