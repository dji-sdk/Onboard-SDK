...
void GridmapKernel::addPoint(int x, int y, int z) { view[x*mpsz*mpsz+y*mpsz+z] = true; }
GridmapKernel::Point *GridmapKernel::getView() const
{
    return view;
}

void GridmapKernel::setView(Point *value)
{
    view = value;
}
