...
void gridmap::mousePressEvent(QMouseEvent *e)
{
    // Save mouse press position
    mousePressPosition = QVector2D(e->localPos());
}

void gridmap::mouseReleaseEvent(QMouseEvent *e)
{
...
void gridmap::resizeGL(int w, int h)
{
