#ifndef DJI_PROTOBUF_STUBS_CALLBACK_H_
#define DJI_PROTOBUF_STUBS_CALLBACK_H_

#include <dji/protobuf/stubs/macros.h>
#include <dji/protobuf/stubs/type_traits.h>

// ===================================================================
// emulates dji3/base/callback.h
...
class LIBPROTOBUF_EXPORT Closure {
 ...
 private:
  DJI_DISALLOW_EVIL_CONSTRUCTORS(Closure);
};
...
class ResultCallback {
 ...
 private:
  DJI_DISALLOW_EVIL_CONSTRUCTORS(ResultCallback);
};
...
class LIBPROTOBUF_EXPORT ResultCallback1 {
 ...
 private:
  DJI_DISALLOW_EVIL_CONSTRUCTORS(ResultCallback1);
};
...
class LIBPROTOBUF_EXPORT ResultCallback2 {
 ...
 private:
  DJI_DISALLOW_EVIL_CONSTRUCTORS(ResultCallback2);
};
...
#endif  // DJI_PROTOBUF_STUBS_CALLBACK_H_
